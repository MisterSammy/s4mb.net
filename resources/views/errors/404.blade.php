...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Page Not Found — {{ config('app.name', 'Sam') }}</title>
    ...
    <body class="bg-obsidian text-fog min-h-screen font-sans antialiased overflow-x-hidden">
        ...
        <div class="relative min-h-screen flex flex-col">
            ...
            <main class="flex-1 flex items-center justify-center py-16 relative overflow-hidden">
                ...
                <div class="orbital absolute -left-32 top-1/2 -translate-y-1/2 animate-slow-spin" style="--orbital-size: 400px;">
                ...
                <div class="arc-group absolute -right-20 -bottom-20 opacity-20">
                ...
                {{-- Tick ring --}}
                <div class="tick-ring absolute right-1/4 top-8 w-[200px] h-[200px] animate-pulse-opacity hidden lg:block"></div>

                <div class="max-w-5xl mx-auto px-6 lg:px-8 relative z-10">
                    <div class="text-center">
                        {{-- Error Code --}}
                        <div class="flex items-center justify-center gap-4 mb-8">
                            <span class="font-mono text-xs text-mist tracking-widest">ERROR</span>
                        ...
                        {{-- Back home link --}}
                        <a href="{{ url('/') }}" class="inline-flex items-center gap-2 font-mono text-sm text-silver hover:text-snow transition-colors hover-line">
