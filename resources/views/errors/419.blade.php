...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Your session has expired. Please refresh and try again.">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        <link rel="dns-prefetch" href="https://fonts.gstatic.com">
        <title>Page Expired — {{ config('app.name', 'Sam') }}</title>
                ...
                <div class="max-w-5xl mx-auto px-6 lg:px-8 relative z-10">
                    <div class="text-center">
                        ...
                        <div class="flex items-center justify-center gap-4 mb-8">
                            <span class="font-mono text-xs text-mist tracking-widest">SESSION EXPIRED</span>
                        ...
                        {{-- Refresh button --}}
                        <button onclick="window.location.reload()" class="inline-flex items-center gap-2 font-mono text-sm text-silver hover:text-snow transition-colors hover-line cursor-pointer">
